...
export const CRITTER_ENEMIES: CritterDesign[] = [
  ...
  { key: "e_swarmer", name: "Swarmer", body: "#6e2fbe", shade: "#2c0b52", eye: "#d68bff", shape: "insect", crown: "antenna", mouth: "fangs", eyes: 2, arms: false, tail: false, size: 0.7, legs: "two", pattern: "plates", brow: "angry", glow: "rgba(150,70,220,0.4)", neon: "#b874ff" },
  ...
  { key: "e_looter", name: "Looter", body: "#c99312", shade: "#5e3f02", eye: "#ffe487", shape: "insect", crown: "shards", mouth: "fangs", eyes: 2, arms: false, tail: false, size: 0.8, legs: "two", pattern: "plates", brow: "flat", glow: "rgba(255,205,70,0.5)", neon: "#ffe08a" },
