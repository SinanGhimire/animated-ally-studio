...
export type CritterEnemyKey =
  | "e_swarmer" | "e_brute" | "e_spitter" | "e_runner"
  | "e_charger" | "e_lobber" | "e_winder" | "e_splinter"
  // ---- special disruptors (blueprint 9-24)
  | "e_healer" | "e_buffer" | "e_shielder" | "e_mummy" | "e_looter"
  | "e_trapper" | "e_leech" | "e_burrower" | "e_bomber" | "e_grappler"
  | "e_cloaker" | "e_splitshot" | "e_orbiter" | "e_waller" | "e_sapper"
  | "e_reaperfoe"
  // ---- elite mini-bosses (blueprint 25-33)
  | "e_rhino" | "e_croc" | "e_monk" | "e_gargoyle" | "e_stalker"
  | "e_hydra" | "e_siren" | "e_colossus" | "e_hivemind"
  // ---- wave guardians (blueprint 34-35)
  | "e_titan" | "e_brood";
...
export const CRITTER_ENEMIES: CritterDesign[] = [
  // ---- Basic Horde (blueprint 1-8)
  { key: "e_swarmer", name: "Swarmer", body: "#6e2fbe", shade: "#2c0b52", eye: "#d68bff", shape: "insect", crown: "antenna", mouth: "fangs", eyes: 2, arms: false, tail: false, size: 0.7, legs: "many", pattern: "plates", brow: "angry", glow: "rgba(150,70,220,0.4)", neon: "#b874ff" },
  { key: "e_brute", name: "Brute", body: "#77202c", shade: "#380a13", eye: "#ff7a5a", shape: "block", crown: "none", mouth: "maw", eyes: 2, arms: true, tail: false, size: 1.45, legs: "two", pattern: "plates", brow: "angry", claws: true },
  { key: "e_spitter", name: "Spitter", body: "#8e9a1c", shade: "#363c05", eye: "#7dff8a", shape: "insect", crown: "turret", mouth: "fangs", eyes: 0, arms: false, tail: false, size: 0.95, legs: "many", pattern: "plates", brow: "angry", glow: "rgba(140,255,150,0.35)" },
  { key: "e_runner", name: "Runner", body: "#16768c", shade: "#03323d", eye: "#8ff6ff", shape: "long", crown: "spikes", mouth: "fangs", eyes: 2, arms: false, tail: false, size: 0.85, legs: "many", pattern: "plates", brow: "angry", glow: "rgba(60,224,240,0.35)", neon: "#7fe8f7" },
  { key: "e_charger", name: "Charger", body: "#4a5364", shade: "#1e242f", eye: "#ff5544", shape: "insect", crown: "pincers", mouth: "fangs", eyes: 2, arms: false, tail: false, size: 1.1, legs: "many", pattern: "plates", brow: "angry", glow: "rgba(255,70,50,0.4)" },
  { key: "e_lobber", name: "Lobber", body: "#8d6f45", shade: "#3f2e14", eye: "#ff9a3c", shape: "sack", crown: "pipe", mouth: "maw", eyes: 2, arms: true, tail: false, size: 1.2, legs: "two", pattern: "plates", brow: "angry", glow: "rgba(255,150,60,0.35)" },
  { key: "e_winder", name: "Winder", body: "#c25411", shade: "#5c1f02", eye: "#ffb46b", shape: "serpent", crown: "fin", mouth: "fangs", eyes: 2, arms: false, tail: false, size: 0.95, legs: "none", pattern: "stripes", brow: "angry", glow: "rgba(255,120,40,0.35)", neon: "#ff9a4e" },
  { key: "e_splinter", name: "Splinter", body: "#5f8fb8", shade: "#1e3c56", eye: "#7cf2ff", shape: "shard", crown: "shards", mouth: "fangs", eyes: 2, arms: false, tail: false, size: 1, legs: "two", pattern: "plates", brow: "angry", core: "#5fdcff", glow: "rgba(90,200,255,0.45)", neon: "#a9e4ff" },

  // ---- Special Disruptors (blueprint 9-24)
  { key: "e_healer", name: "Healer", body: "#1e9c74", shade: "#053b2c", eye: "#7dffd2", shape: "jelly", crown: "none", mouth: "maw", eyes: 2, arms: false, tail: false, size: 1, legs: "none", pattern: "stripes", brow: "flat", glow: "rgba(60,255,190,0.45)", neon: "#7dffd2" },
  { key: "e_buffer", name: "Buffer", body: "#9c1a2e", shade: "#43040f", eye: "#ff6a6a", shape: "totem", crown: "spikes", mouth: "none", eyes: 1, arms: false, tail: false, size: 1.05, legs: "none", pattern: "plates", glow: "rgba(255,60,60,0.5)", neon: "#ff8f8f" },
  { key: "e_shielder", name: "Shielder", body: "#48678c", shade: "#1c2c40", eye: "#9fd8ff", shape: "mech", crown: "pavise", mouth: "fangs", eyes: 2, arms: true, tail: false, size: 1.2, legs: "two", pattern: "plates", brow: "angry", glow: "rgba(90,170,255,0.3)" },
  { key: "e_mummy", name: "Mummy", body: "#9a9689", shade: "#474338", eye: "#c69bff", shape: "tall", crown: "none", mouth: "maw", eyes: 2, arms: true, tail: false, size: 1.05, legs: "two", pattern: "stripes", brow: "angry", glow: "rgba(170,110,255,0.28)" },
  { key: "e_looter", name: "Looter", body: "#c99312", shade: "#5e3f02", eye: "#ffe487", shape: "insect", crown: "shards", mouth: "fangs", eyes: 2, arms: false, tail: false, size: 0.8, legs: "many", pattern: "plates", brow: "flat", glow: "rgba(255,205,70,0.5)", neon: "#ffe08a" },
  { key: "e_trapper", name: "Trapper", body: "#6f747d", shade: "#2c3036", eye: "#ffb838", shape: "wide", crown: "spikes", mouth: "none", eyes: 3, arms: false, tail: false, size: 0.9, legs: "many", pattern: "plates", glow: "rgba(255,180,60,0.35)" },
  { key: "e_leech", name: "Leech", body: "#c9558c", shade: "#5a1338", eye: "#ffb0d8", shape: "worm", crown: "none", mouth: "maw", eyes: 0, arms: false, tail: false, size: 0.95, legs: "none", pattern: "stripes", core: "#ff9ccb", glow: "rgba(255,110,180,0.4)", neon: "#ffa8d4" },
  { key: "e_burrower", name: "Burrower", body: "#6f5b41", shade: "#2f2417", eye: "#ffd489", shape: "block", crown: "drill", mouth: "fangs", eyes: 2, arms: false, tail: false, size: 1.1, legs: "two", pattern: "plates", brow: "angry" },
  { key: "e_bomber", name: "Bomber", body: "#c95f10", shade: "#5c2402", eye: "#ffd24a", shape: "orb", crown: "spikes", mouth: "maw", eyes: 2, arms: false, tail: false, size: 1, legs: "two", pattern: "spots", brow: "angry", core: "#ffbe3a", glow: "rgba(255,140,40,0.5)", neon: "#ffb463" },
  { key: "e_grappler", name: "Grappler", body: "#4f9840", shade: "#1c4213", eye: "#ffe07a", shape: "tall", crown: "antenna", mouth: "maw", eyes: 2, arms: true, tail: true, size: 0.95, legs: "none", pattern: "stripes", brow: "angry" },
  { key: "e_cloaker", name: "Cloaker", body: "#7b8fa1", shade: "#2a3540", eye: "#e6f6ff", shape: "ghost", crown: "none", mouth: "fangs", eyes: 2, arms: false, tail: false, size: 1, legs: "none", pattern: "none", brow: "angry", neon: "#dff1ff", glow: "rgba(190,225,255,0.28)" },
  { key: "e_splitshot", name: "Split-Shooter", body: "#8641d0", shade: "#3b1163", eye: "#d8ffb0", shape: "insect", crown: "turret", mouth: "fangs", eyes: 3, arms: false, tail: false, size: 1.05, legs: "many", pattern: "plates", brow: "angry", glow: "rgba(180,110,255,0.4)" },
  { key: "e_orbiter", name: "Orbiter", body: "#2496bd", shade: "#083c52", eye: "#a6f0ff", shape: "orb", crown: "rings", mouth: "none", eyes: 1, arms: false, tail: false, size: 0.85, legs: "none", pattern: "plates", core: "#8fe8ff", glow: "rgba(80,215,255,0.5)", neon: "#8fe8ff" },
  { key: "e_waller", name: "Waller", body: "#68a02c", shade: "#274a08", eye: "#c8ff6b", shape: "mech", crown: "pipe", mouth: "maw", eyes: 2, arms: false, tail: false, size: 1.15, legs: "none", pattern: "plates", brow: "angry", glow: "rgba(150,220,70,0.4)" },
  { key: "e_sapper", name: "Sapper", body: "#8d6431", shade: "#3d2710", eye: "#c48cff", shape: "orb", crown: "rings", mouth: "none", eyes: 1, arms: false, tail: false, size: 0.9, legs: "none", pattern: "plates", glow: "rgba(180,110,255,0.4)" },
  { key: "e_reaperfoe", name: "Reaper", body: "#23203a", shade: "#0b0a16", eye: "#ff5a7a", shape: "ghost", crown: "scythes", mouth: "none", eyes: 2, arms: true, tail: false, size: 1.1, legs: "none", pattern: "none", brow: "angry", glow: "rgba(255,70,110,0.4)", neon: "#ff8fa8" },

  // ---- Elite Mini-Bosses (blueprint 25-33)
  { key: "e_rhino", name: "Rhino", body: "#5b636e", shade: "#252b32", eye: "#ffd9a8", shape: "block", crown: "hornsteel", mouth: "maw", eyes: 2, arms: true, tail: false, size: 1.5, legs: "two", pattern: "plates", brow: "angry", claws: true },
  { key: "e_croc", name: "Crocodile", body: "#23513a", shade: "#0b2417", eye: "#ffe066", shape: "long", crown: "fin", mouth: "maw", eyes: 2, arms: false, tail: true, size: 1.3, legs: "two", pattern: "plates", brow: "angry", glow: "rgba(120,200,160,0.25)" },
  { key: "e_monk", name: "Monk", body: "#b8a97c", shade: "#5d4f26", eye: "#5cc8ff", shape: "totem", crown: "rings", mouth: "none", eyes: 2, arms: true, tail: false, size: 1.2, legs: "none", pattern: "plates", brow: "flat", glow: "rgba(255,225,140,0.4)", neon: "#ffe9b0" },
  { key: "e_gargoyle", name: "Gargoyle", body: "#33303f", shade: "#141220", eye: "#ff9d3a", shape: "block", crown: "horns", mouth: "fangs", eyes: 2, arms: true, tail: true, size: 1.35, legs: "two", pattern: "plates", brow: "angry", wings: true, claws: true },
  { key: "e_stalker", name: "Stalker", body: "#1f1b2c", shade: "#0a0812", eye: "#ff3344", shape: "tall", crown: "fin", mouth: "none", eyes: 2, arms: true, tail: false, size: 1.1, legs: "two", pattern: "none", brow: "angry", glow: "rgba(255,40,60,0.35)", neon: "#ff6b7a" },
  { key: "e_hydra", name: "Hydra", body: "#2f6f9c", shade: "#0f3350", eye: "#ffe066", shape: "serpent", crown: "spikes", mouth: "maw", eyes: 3, arms: false, tail: true, size: 1.35, legs: "none", pattern: "plates", brow: "angry", glow: "rgba(80,170,230,0.35)", neon: "#7fc4f0" },
  { key: "e_siren", name: "Siren", body: "#cfc2e8", shade: "#6f6293", eye: "#ff6bd0", shape: "jelly", crown: "megaphone", mouth: "fangs", eyes: 3, arms: true, tail: false, size: 1.25, legs: "none", pattern: "stripes", brow: "angry", wings: true, glow: "rgba(255,140,220,0.4)", neon: "#ffb6ea" },
  { key: "e_colossus", name: "Colossus", body: "#585f68", shade: "#22262c", eye: "#ff4a2a", shape: "tripod", crown: "turret", mouth: "none", eyes: 0, arms: false, tail: false, size: 1.6, legs: "none", pattern: "plates", glow: "rgba(255,80,40,0.45)" },
  { key: "e_hivemind", name: "Hivemind", body: "#c46f92", shade: "#5a2440", eye: "#7cf2ff", shape: "brain", crown: "rings", mouth: "none", eyes: 1, arms: false, tail: false, size: 1.4, legs: "none", pattern: "spots", core: "#ffb6cf", glow: "rgba(255,150,200,0.45)", neon: "#ffc0da" },

  // ---- Final Wave Guardians (blueprint 34-35)
  { key: "e_titan", name: "The Titan", body: "#241f2f", shade: "#0d0b14", eye: "#ffb02e", shape: "shard", crown: "shards", mouth: "maw", eyes: 2, arms: true, tail: false, size: 1.9, legs: "two", pattern: "plates", brow: "angry", claws: true, core: "#ff8a1f", glow: "rgba(255,140,40,0.55)", neon: "#ffbf6b" },
  { key: "e_brood", name: "The Broodmother", body: "#83305e", shade: "#3a0c2b", eye: "#b6ff7a", shape: "mound", crown: "spikes", mouth: "maw", eyes: 3, arms: false, tail: false, size: 2, legs: "none", pattern: "spots", core: "#e07ab0", glow: "rgba(255,110,190,0.45)", neon: "#e79bc9" },
